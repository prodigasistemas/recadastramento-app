	...
	public boolean areCamposObrigatoriosOk(){
		...
		if ( ((Spinner)view.findViewById(R.id.spinnerDefineResponsavel)).getSelectedItemPosition() > 1){
			...
			if (isResponsavelCpfSelected){
				...
				}else if(!cpfCnpjOriginal.equals("") && (((EditText)view.findViewById(R.id.cpfCnpjResponsavel)).getText().toString().trim().compareTo("") == 0)){
		...
		if (((RadioGroup)view.findViewById(R.id.groupUsuarioEProprietario)).getCheckedRadioButtonId() == R.id.radioNao) {
			...
			if( (((EditText)view.findViewById(R.id.cepProprietario)).getText().toString().trim().compareTo("") == 0)){
				...
				if (isProprietarioCpfSelected){
					...
					}else if(!cpfCnpjOriginal.equals("") && (((EditText)view.findViewById(R.id.cpfCnpjProprietario)).getText().toString().trim().compareTo("") == 0)){
