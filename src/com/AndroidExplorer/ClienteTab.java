...
public class ClienteTab extends Fragment implements LocationListener {
	...
	private String cpfCnpjOriginalUsuario;
	private String cpfCnpjOriginalResponsavel;
	private String cpfCnpjOriginalProprietario;
	...
	private void checkedNovoProprietario() {
		final CheckBox novoProprietario = (CheckBox) view.findViewById(R.id.novoProprietario);
	...
	private void limparDadosProprietario() {
		((EditText) (view.findViewById(R.id.nomeProprietario))).setText("");
		((Spinner) (view.findViewById(R.id.spinnerTipoPessoaProprietario))).setSelection(0);
		((EditText) (view.findViewById(R.id.ufProprietario))).setText("");
		...
		((EditText) (view.findViewById(R.id.rgProprietario))).setText("");
		((EditText) (view.findViewById(R.id.foneProprietario))).setText("");
		((EditText) (view.findViewById(R.id.celularProprietario))).setText("");
		((EditText) (view.findViewById(R.id.emailProprietario))).setText("");
		((EditText) (view.findViewById(R.id.logradouroProprietario))).setText("");
		((EditText) (view.findViewById(R.id.numeroProprietario))).setText("");
		((EditText) (view.findViewById(R.id.municipioProprietario))).setText("");
		((EditText) (view.findViewById(R.id.complementoProprietario))).setText("");
	...
	public void inflateDadosProprietario(){
        ...
        if (getCliente().getProprietario().getMatricula() <= 0) {
			...
			getCliente().setNovoProprietario(true);
		}
	...
	public void setProprietarioCpfOrCnpjTextField(int position){
		if(consideraEventoItemSelectedListenerCpfCnpjProprietario){
			...
			if (position == getCliente().getProprietario().getTipoPessoa() && !getCliente().getProprietario().getCpfCnpj().equals("")){
                ((EditText)(view.findViewById(R.id.cpfCnpjProprietario))).setText(String.valueOf(getCliente().getProprietario().getCpfCnpj().substring(0, Constantes.PARCIAL_CPF_CNPJ)));
                String cpfCnpjOriginalProprietario = getCliente().getProprietario().getCpfCnpj().substring(0, Constantes.PARCIAL_CPF_CNPJ);
    		}else{
            	((EditText)view.findViewById(R.id.cpfCnpjProprietario)).setText("");
    		}
	...
	public void setUsuarioCpfOrCnpjTextField(int position){
		if(consideraEventoItemSelectedListenerCpfCnpjUsuario){
			...
			if (position == getCliente().getUsuario().getTipoPessoa() && !getCliente().getUsuario().getCpfCnpj().equals("")){
                ((EditText)(view.findViewById(R.id.cpfCnpjUsuario))).setText(String.valueOf(getCliente().getUsuario().getCpfCnpj().substring(0, Constantes.PARCIAL_CPF_CNPJ)));
                String cpfCnpjOriginalUsuario = getCliente().getUsuario().getCpfCnpj().substring(0, Constantes.PARCIAL_CPF_CNPJ);
    		}else{
            	((EditText)view.findViewById(R.id.cpfCnpjUsuario)).setText("");
    		}
	...
	public void setResponsavelCpfOrCnpjTextField(int position){
		if(consideraEventoItemSelectedListenerCpfCnpjResponsavel){
    		...
    		if (position == getCliente().getResponsavel().getTipoPessoa() && !getCliente().getResponsavel().getCpfCnpj().equals("")){
                ((EditText)(view.findViewById(R.id.cpfCnpjResponsavel))).setText(String.valueOf(getCliente().getResponsavel().getCpfCnpj().substring(0, Constantes.PARCIAL_CPF_CNPJ)));
                String cpfCnpjOriginalResponsavel = getCliente().getResponsavel().getCpfCnpj().substring(0, Constantes.PARCIAL_CPF_CNPJ);
