...
public class ArquivoRetorno {
	...
	public void gerarPorImovel(Imovel imovel, Activity activity) {
		this.manipulator = Controlador.getInstancia().getCadastroDataManipulator();
		
		Cliente cliente = manipulator.selectClientePorId(imovel.getImovelId());
		Servicos servicos = manipulator.selectServicos(imovel.getImovelId());
		Medidor medidor = manipulator.selectMedidorPorId(imovel.getImovelId());
		AnormalidadeImovel anormalidade = manipulator.selectAnormalidadeImovel(String.valueOf(imovel.getMatricula()));

		StringBuffer conteudo = new StringBuffer(gerarHeader(activity));
		...
		conteudo.append(gerarLinhaServico(imovel, servicos));
	...
	public String gerarHeader(Activity activity) {
		...
		linha.append(Util.adicionarZerosEsquerdaNumero(10, activity.getString(R.string.app_versao)));
	...
	public String gerarLinhaCliente(Cliente cliente) {
		...
		linha.append(Util.adicionarZerosEsquerdaNumero(9, String.valueOf(cliente.getMatricula())));
	...
	public String gerarLinhaServico(Imovel imovel, Servicos servicos) {
